spec = Gem::Specification.new do |s|
  ...
  s.files = %w( CREDITS CHANGELOG MIT-LICENSE README.rdoc Rakefile rails/init.rb
  ...
  s.has_rdoc          = true
  s.extra_rdoc_files += ['README.rdoc', 'CHANGELOG', 'CREDITS', 'MIT-LICENSE']
  s.rdoc_options     += [
    '--title', 'Google Analytics', '--main', 'README.rdoc', '--line-numbers'
  ]
